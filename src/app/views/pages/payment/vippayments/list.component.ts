...
@Component({
  selector: 'app-vipayments',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class VipPaymentsComponent implements OnInit {
  ...
  getPageConfig() {
    this.packageService.getPaymentPage({ vip:true,limit: this.page.size, withPassive: true }, (result: any) => {
