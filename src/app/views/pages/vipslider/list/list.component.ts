...
export class ListComponent implements OnInit {
  ...
  getPageConfig() {
    this.sliderService.getVipSliderPage({ limit: this.page.size, withPassive: true }, (result: any) => {
  ...
  getProfileList() {
    ...
    this.sliderService.getVipSliderList(
      params,
      (result: any) => {
        this.data = result;
        this.isLoading = false;
  ...
  delete(_id) {
    Swal.fire({
      ...
      text: "Slider silme işlemini lütfen onaylayın. Bu işlem geri alınamaz",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        this.userService.delete('vip-slider', { _id }, result => {

          Swal.fire({
            title: 'Slider Silinmiştir',
            icon: 'success',
            timer: 2000,
